...
import { SettingsView, type DictFilterSettings } from './SettingsView'
...
interface SidebarContentProps {
  ...
  // Settings Props (Grouped for cleanliness, or flattened)
  settingsProps: {
...
export const SidebarContent = memo<SidebarContentProps>(props => {
  ...
  if (activeTab === 'settings') {
    return (
      <SettingsView
        detailsFontSize={props.settingsProps.detailsFontSize}
        filters={props.settingsProps.filters}
        highlightInDetails={props.settingsProps.highlightInDetails}
        highlightInList={props.settingsProps.highlightInList}
        isRegex={props.settingsProps.isRegex}
        searchInContent={props.settingsProps.searchInContent}
        setDetailsFontSize={props.settingsProps.setDetailsFontSize}
        setFilters={props.settingsProps.setFilters}
        setHighlightInDetails={props.settingsProps.setHighlightInDetails}
        setHighlightInList={props.settingsProps.setHighlightInList}
        setIsRegex={props.settingsProps.setIsRegex}
        setSearchInContent={props.settingsProps.setSearchInContent}
        setUiFontSize={props.settingsProps.setUiFontSize}
        uiFontSize={props.settingsProps.uiFontSize}
        onOpenKhmerTable={props.settingsProps.onOpenKhmerTable}
      />
    )
  }
