...
export const NonKhmerHideToggleIcon = memo(function NonKhmerHideToggleIcon({
  ...
  return (
    ...
    >
      ...
      >
        <span className={cn('font-bold leading-none', details_header__sup_text_className)}>A</span>
      </div>
      ...
      <div className="absolute -bottom-[40%] -right-[25%] z-10">
