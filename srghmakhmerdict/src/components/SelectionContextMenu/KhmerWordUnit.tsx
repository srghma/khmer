...
export const KhmerWordUnit = React.memo(({ word, definitionHtml, colorIndex, colorization }: KhmerWordUnitProps) => {
  ...
  return (
    <div className="inline-flex flex-col items-center mx-[2px] align-top vertical-align-top relative group">
      {/* 1. The Khmer Word */}
      <span className={`font-khmer text-lg leading-normal cursor-text select-text ${wordClass}`}>{word}</span>
