...
const SuccessModal = memo(({ isOpen, onClose }: { isOpen: boolean; onClose: () => void }) => {
  ...
  return (
    <Modal backdrop="blur" isOpen={isOpen} size="xs" onOpenChange={onClose}>
      <ModalContent className="bg-gradient-to-br from-success-50 to-white dark:from-success-900/20 dark:to-background border border-success-200 scaling-details">
...
const CancellationModal = memo(({ isOpen, onClose }: { isOpen: boolean; onClose: () => void }) => {
  ...
  return (
    <Modal backdrop="blur" isOpen={isOpen} size="xs" onOpenChange={onClose}>
      <ModalContent className="bg-gradient-to-br from-danger-50 to-white dark:from-danger-900/20 dark:to-background border border-danger-200 scaling-details">
        <ModalHeader className="flex flex-col gap-1 items-center pb-0">
