pub use super::common::ShortDefinitionKm;
use super::common::{
    KmShortDefinitionSource, WordRow, fetch_many, get_placeholders,
...
pub const KM_SHORT_DESC_COALESCE: &str = "COALESCE(from_csv_rawHtml, en_km_com, Desc, from_chuon_nath_translated, wiktionary, from_russian_wiki, gorgoniev)";
pub const KM_SHORT_DESC_SOURCE: &str = "(CASE
...
pub async fn get_km_words_impl(state: &AppState) -> Result<Vec<KmWord>, String> {
...
pub async fn get_word_detail_km_impl(
    state: &AppState,
    word: String,
...
pub async fn search_km_content_impl(
    state: &AppState,
    query: String,
...
pub async fn km_for_many_short_description_none_if_word_not_found_impl(
    state: &AppState,
    words: Vec<String>,
...
pub async fn km_for_many_short_description_throws_if_word_not_found_impl(
    state: &AppState,
    words: Vec<String>,
...
pub async fn km_for_many_full_details_none_if_word_not_found_impl(
    state: &AppState,
    words: Vec<String>,
...
pub async fn km_for_many_full_details_throws_if_word_not_found_impl(
    state: &AppState,
    words: Vec<String>,
