...
// **вагон-ресторан**
const RussianWordDictionaryIndexElement_REGEX_dephis =
...
export const isRussianWordDictionaryIndexElement = (
  value: string,
): value is TypedRussianWordDictionaryIndexElement =>
...
export const strToRussianWordDictionaryIndexElementOrThrow = (
  ...
  if (!uuid)
    throw new Error(
      `Invalid RussianWordDictionaryIndexElement format: '${value}'`,
    )
  return uuid
}
...
export type TypedRussianWordDictionaryIndex =
  NonEmptySet<TypedRussianWordDictionaryIndexElement>
