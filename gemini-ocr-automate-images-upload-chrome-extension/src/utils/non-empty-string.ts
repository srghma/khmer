...
export function String_toNonEmptyString_orUndefined(
  str: string,
...
export function String_toNonEmptyString_orUndefined_afterTrim(
  str: string,
): NonEmptyString | undefined {
...
export function String_toNonEmptyString_afterTrim(
  str: string,
...
export function arrayOfNonEmptyString_filterOut_afterTrim(
  arr: string[],
): readonly NonEmptyString[] {
