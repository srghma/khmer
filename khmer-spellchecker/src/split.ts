...
'ផ្លូវ  កខ្វេងកខ្វាក់'
=>['ផ្លូវ', '  ', 'កខ្វេងក', 'ខ្វាក់']
'ផ្លូវ  tst កខ្វេងកខ្វាក់'
=>['ផ្លូវ', '  ', 'tst', ' ', 'កខ្វេងក', 'ខ្វាក់']
'ផ្លូវ  tstកខ្វេងកខ្វាក់'
=>['ផ្លូវ', '  ', 'tstកខ្វេងក', 'ខ្វាក់']
 */
const segmenter = new Intl.Segmenter("km", { granularity: "word" })
export function khmerSentenceToWords_usingSegmenter(str: string): string[] {
...
khmerSentenceToWords_usingDictionary('ផ្លូវ កខ្វេងកខ្វាក់', new Set(khmerSentenceToWords_usingSegmenter('ផ្លូវកខ្វេងកខ្វាក់')))
khmerSentenceToWords_usingDictionary('ផ្លូវ  កខ្វេងកខ្វាក់', new Set(khmerSentenceToWords_usingSegmenter('ផ្លូវកខ្វេងកខ្វាក់')))
khmerSentenceToWords_usingDictionary('ផ្លូវ  tst កខ្វេងកខ្វាក់', new Set(khmerSentenceToWords_usingSegmenter('ផ្លូវកខ្វេងកខ្វាក់')))
khmerSentenceToWords_usingDictionary('ផ្លូវ  tstកខ្វេងកខ្វាក់', new Set(khmerSentenceToWords_usingSegmenter('ផ្លូវកខ្វេងកខ្វាក់')))
...
export function khmerSentenceToWords_usingDictionary(
  ...
  while (i < chars.length) {
    ...
    if (longestMatchString) {
      result.push(longestMatchString)
      i += longestMatchLen
    } else {
      // Unknown: take 1 char
      result.push(chars[i]!)
...
export type WordsOrSpaces = string | Space
